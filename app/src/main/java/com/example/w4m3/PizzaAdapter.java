...
import com.example.w4m3.databinding.ItemPizzaBinding;
...
public class PizzaAdapter extends RecyclerView.Adapter<PizzaViewHolder> {
    ...
    com.example.w4m3.OnItemClick onItemClick;

    public PizzaAdapter(ArrayList<PizzaModel> pizza, com.example.w4m3.OnItemClick onItemClick) {
        this.pizza = pizza;
...
class PizzaViewHolder extends RecyclerView.ViewHolder {
    ...
    public void onBind(PizzaModel pizzaModel) {
        ...
        binding.tvPrice.setText(pizzaModel.price + "$");
